...
useEffect(()=>{
    ...
    return (
        <div className='container row'>
            ...
            <div className='col-8'>
                <input name='task' type="text" value={task} placeholder='Write your task' className='form-control'
                onChange ={(e)=>setTask(e.target.value)}
                />
            </div>
            <div className='col-4'>
                <button className='btn btn-primary from-control material-icons' onClick={addTask}>add</button>
            </div>
            <div className='badge'>
                You have
                {
